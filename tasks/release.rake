...
### [v#{ENV['PRODUCT_VERSION']}](https://github.com/realityforge/gwt-qr-code/tree/v#{ENV['PRODUCT_VERSION']}) (#{ENV['RELEASE_DATE']})
[Full Changelog](https://github.com/realityforge/gwt-qr-code/compare/v#{ENV['PREVIOUS_PRODUCT_VERSION']}...v#{ENV['PRODUCT_VERSION']})
HEADER
